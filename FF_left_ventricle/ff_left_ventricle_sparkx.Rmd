...
```{r}
coordinates <- ff_left_ventricle_seurat@images$slice.1@coordinates
...
```{r}
##Need count matrix
counts <- as.matrix(ff_left_ventricle_seurat@assays$RNA@counts)
```
...
#write this to file
write.csv(sig_res,'ff_left_ventricle_sparkx_sig_SVGS_adj_pval.csv')
```