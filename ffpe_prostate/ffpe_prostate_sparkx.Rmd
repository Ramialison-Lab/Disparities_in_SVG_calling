...
```{r}
coordinates <- ffpe_prostate_seurat@images$slice.1@coordinates
...
```{r}
##Need count matrix
counts <- as.matrix(ffpe_prostate_seurat@assays$RNA@counts)
```
...
#write this to file
write.csv(sig_res,'ffpe_prostate_sparkx_sig_SVGS_adj_pval.csv')
```