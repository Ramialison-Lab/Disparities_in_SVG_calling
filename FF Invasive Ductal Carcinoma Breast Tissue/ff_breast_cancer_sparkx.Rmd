...
```{r}
coordinates <- ff_breast_cancer_seurat@images$slice.1@coordinates
...
```{r}
##Need count matrix
counts <- as.matrix(ff_breast_cancer_seurat@assays$RNA@counts)
```
...
#write this to file
write.csv(sig_res,'ff_breast_cancer_sparkx_sig_SVGS_adj_pval.csv')
```