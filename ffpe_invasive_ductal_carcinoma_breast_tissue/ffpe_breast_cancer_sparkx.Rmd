---
title: "Run SPARKX analysis on scanpy processed FFPE breast cancer data"
...
```{r}
coordinates <- ffpe_breast_cancer_seurat@images$slice.1@coordinates
...
```{r}
##Need count matrix
counts <- as.matrix(ffpe_breast_cancer_seurat@assays$RNA@counts)
```
...
write.csv(sig_res,'ffpe_breast_cancer_spark_sig_SVGS_adj_pval.csv')
```